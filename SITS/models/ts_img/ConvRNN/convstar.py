    ...
    def forward(self, input_, prev_state,device):
        ...
        if prev_state is None:
            ...
            if torch.cuda.is_available():
                prev_state = Variable(torch.zeros(state_size)).to(device)
            else:
...
class ConvSTAR(nn.Module):
    ...
    def __init__(self, input_size, hidden_sizes, kernel_sizes, n_layers):
        ...
        for i in range(self.n_layers):
            ...
            setattr(self, name, cell)  #self.name=cell
            cells.append(getattr(self, name))

        self.cells = cells

    def forward(self, x, hidden=None,device=None):
        '''
        Parameters
        ----------
        ...
        for layer_idx in range(self.n_layers):
            ...
            # pass through layer
            upd_cell_hidden = cell(input_, cell_hidden,device)
