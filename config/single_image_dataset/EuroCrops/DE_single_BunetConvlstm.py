...
#                    weight_decay=0.0001),
    ...
    meta=dict(
        ...
        model_name="Bunetconvlstm_prldam_prcd",
        num_each_level=dict(
...
infer_config = dict(
    infer=dict(
        ...
        meta=dict(
            ...
            area="DE",
            model_name="Bunetconvlstm_prldam_cd",
            gpu_ids=[1],
            optimal_epoch=50,
            ...
            save_path="/data1/ll20/Pub_dataset/EuroCrops/DE_2021/result_2/mini_2_sl_l3/Bunetconvlstm_prldam_cd/",
            num_classlevel=[101],
            label_level=3,
            map_dict={
          ...
          save_fea_path="/data1/ll20/Pub_dataset/EuroCrops/DE_2021/result_2/mini_2_sl_l3/ablation/bunetconvlstm/fea_vis",
