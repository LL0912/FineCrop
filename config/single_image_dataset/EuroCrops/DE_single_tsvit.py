...
#                    weight_decay=0.0001),
    ...
    meta=dict(
        ...
        train_level=3,
        model_name="tsvit",
        train_mode="ltpr_ltpr_cdce", #[lt_dw,ltpr_no,ltpr_dw,ce_no]
        num_each_level=dict(
...
#         ),
        ...
        meta=dict(
            ...
            save_path="/data1/ll20/Pub_dataset/EuroCrops/DE_2021/result_2/mini_2_sl_l3/tsvit",
            num_classlevel=[101],
            label_level=3,
            map_dict={
          ...
          test_label_rgb_path="/data1/ll20/Pub_dataset/EuroCrops/DE_2021/NPY_mini_norm_crop_small_2/test_label_rgb",
          save_fea_path="/data1/ll20/Pub_dataset/EuroCrops/DE_2021/result_2/mini_2_sl_l3/ablation/utae/fea_vis",
