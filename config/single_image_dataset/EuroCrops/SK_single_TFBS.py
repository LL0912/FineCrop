...
#                    params=dict(ignore_index=255)),
       ...
       loss_cd=dict(
#                    type="ChaneldeviParcelLoss",
#                    params=dict(cnum=4,
#                    num_class=73,
#                    use_mask=True,
#                    ignore_index=255)
                   type="ChanneldevilLoss",
                   params=dict(cnum=4,
                   num_class=73,
                   use_mask=True,
                   ignore_index=255)
...
#                    weight_decay=0.0001),
    ...
    meta=dict(
        ...
        train_level=3,
        model_name="tfbs_fg",
        train_mode="ltpr_no_cdce", #[ltpr_no_cdce,ce_no_no] 
...
#                     channel_group=4
        ...
        meta=dict(
            ...
            save_path="/data1/ll20/Pub_dataset/EuroCrops/SK_select/result_2/mini_2_sl_l3/tfbs/",
            num_classlevel=[73],
            label_level=3,
            map_dict={
                1: {
          ...
          save_fea_path="/data1/ll20/Pub_dataset/EuroCrops/SK_select/result_2/mini_2_sl_l3/ablation/tfbs/fea_vis",
