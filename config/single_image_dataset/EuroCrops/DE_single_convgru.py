config= dict(
    dataset=dict(
        train=dict(type="ImageBase_MultiLevel_Dataset",
                   params=dict(
                       data_path="/data1/ll20/Pub_dataset/EuroCrops/DE_2021/NPY_mini_norm_crop_small/train",
        ...
        val=dict(type="ImageBase_MultiLevel_Dataset",
                 params=dict(
                     data_path="/data1/ll20/Pub_dataset/EuroCrops/DE_2021/NPY_mini_norm_crop_small/val",
                     doy={"32ULB": [62, 152, 282, 297],
                            "32ULC": [42, 117, 152, 237, 282, 297],
                            "32UMC": [44,52,89,117,164,252,282,297],
                            "32UMB": [44,54,89,164,199,354]},
        ...
        test=dict(type="ImageBase_MultiLevel_Dataset",
                  params=dict(
                      data_path="/data1/ll20/Pub_dataset/EuroCrops/DE_2021/NPY_mini_norm_crop_small/test",
                      doy={"32ULB": [62, 152, 282, 297],
                            "32ULC": [42, 117, 152, 237, 282, 297],
                            "32UMC": [44,52,89,117,164,252,282,297],
                            "32UMB": [44,54,89,164,199,354]},
...
##     ),
    ...
    loss_function=dict(
        ...
        loss_cd=dict(type="ChanneldevilLoss",
                    params=dict(cnum=5,
                    num_class=101,
                    use_mask=True,
                    ignore_index=255)),
...
#                    weight_decay=0.0001),
    ...
    meta=dict(
        ...
        ignore_index=255,
        save_path=r"/data1/ll20/Pub_dataset/EuroCrops/DE_2021/result/mini_2_sl_l3/convgru_ablation/prldam_cd_5",
        area="DE",
        num_classlevel=[7, 40, 101, 133],
        best_iter=50,
        train_level=3,
        train_mode="ltpr_no_cdce", #[lt_dw,ltpr_no,ltpr_dw,ce_no] 
        model_name="convgru_prldam_cd",
        num_each_level=dict(
...
#                     n_layers=8,
        ...
        meta=dict(
            ...
            area="DE",
            model_name="convgru_prldam_no_cd",
            gpu_ids=[2],
            optimal_epoch=43,
            ...
            save_path="/data1/ll20/Pub_dataset/EuroCrops/DE_2021/result_2/mini_2_sl_l3/convgru_prldam_no_cd/",
            num_classlevel=[101],
            label_level=3,
            map_dict={
          ...
          save_fea_path="/data1/ll20/Pub_dataset/EuroCrops/DE_2021/result_2/mini_2_sl_l3/ablation/convgru/fea_vis",
