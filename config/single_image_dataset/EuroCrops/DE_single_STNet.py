...
#                    weight_decay=0.0001),
    ...
    meta=dict(
        ...
        ignore_index=255,
        save_path=r"/data1/ll20/Pub_dataset/EuroCrops/DE_2021/result_2/mini_2_sl_l3/stnet_fg",
        area="DE",
...
infer_config = dict(
    infer=dict(
        ...
        meta=dict(
            ...
            save_path="/data1/ll20/Pub_dataset/EuroCrops/DE_2021/result_2/mini_2_sl_l3/stnet/",
            num_classlevel=[101],
            label_level=3,
            map_dict={
