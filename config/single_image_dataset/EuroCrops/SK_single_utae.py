...
#                    weight_decay=0.0001),
    ...
    meta=dict(
        ...
        ignore_index=255,
        save_path="/data1/ll20/Pub_dataset/EuroCrops/SK_select/result_2/mini_2_sl_l3/discussion",
        area="SK",
        best_iter=50,
        max_iter=50,
        train_level=3,
        model_name="utae_fg_4",
        train_mode="ltpr_no_cdce", #[lt_dw_no,ltpr_no,ltpr_dw_no,ce_no_no,ltpr_no_ce,ltpr_no_ag,ltpr_dw_ag,ltpr_no_cdce] #��һ����ʾ�Ƿ�ʹ�����ƽ��ֲ����ڶ�����ʾ��̬�ļ�Ȩ����������ʾ�Ƿ�ʹ�öԱ�ѧϰ,����ͨ����ǿ 
...
#         ),
       ...
       params=dict(
        ...
        meta=dict(
            ...
            save_path="/data1/ll20/Pub_dataset/EuroCrops/SK_select/result_2/mini_2_sl_l3/utae",
            num_classlevel=[73],
            label_level=3,
            no_data=255,
            map_dict={
          ...
          save_fea_path="/data1/ll20/Pub_dataset/EuroCrops/SK_select/result_2/mini_2_sl_l3/ablation/utae/fea_vis",
