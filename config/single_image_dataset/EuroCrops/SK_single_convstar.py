...
#                    weight_decay=0.0001),
    ...
    meta=dict(
        ...
        train_level=3,
        model_name="convstar",
        train_mode="ce_no_no", #[ltpr_no_cdce,ce_no_no] 
...
infer_config = dict(
    infer=dict(
        ...
        meta=dict(
            ...
            save_path="/data1/ll20/Pub_dataset/EuroCrops/SK_select/result_2/mini_2_sl_l3/convstar_prsoft_cd/",
            num_classlevel=[73],
            label_level=3,
            no_data=255,
            map_dict={
          ...
          save_fea_path="/data1/ll20/Pub_dataset/EuroCrops/SK_select/result_2/mini_2_sl_l3/ablation/convstar/fea_vis",
