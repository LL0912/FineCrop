...
#                    weight_decay=0.0001),
    ...
    meta=dict(
        ...
        ignore_index=255,
        save_path=r"/data1/ll20/Pub_dataset/EuroCrops/DE_2021/result/mini_2_sl_l3/convlstm_ablation",
        area="DE",
        num_classlevel=[7, 40, 101, 133],
        best_iter=50,
        train_level=3,
        train_mode="ltpr_no_cdce", #[lt_dw,ltpr_no,ltpr_dw,ce_no] 
        model_name="convlstm_prldam_cdce_5",
        num_each_level=dict(
...
#                     n_layers=8,
        ...
        meta=dict(
            ...
            save_path="/data1/ll20/Pub_dataset/EuroCrops/DE_2021/result_2/mini_2_sl_l3/convlstm_ltpr_cd/",
            num_classlevel=[101],
            label_level=3,
            map_dict={
          ...
          save_fea_path="/data1/ll20/Pub_dataset/EuroCrops/DE_2021/result_2/mini_2_sl_l3/ablation/convlstm/fea_vis",
