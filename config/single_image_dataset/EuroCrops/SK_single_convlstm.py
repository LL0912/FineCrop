...
#                    use_convblock=True
        ...
        meta=dict(
            ...
            save_path="/data1/ll20/Pub_dataset/EuroCrops/SK_select/result_2/mini_2_sl_l3/convlstm/",
            num_classlevel=[73],
            label_level=3,
            map_dict={
                1: {
          ...
          save_fea_path="/data1/ll20/Pub_dataset/EuroCrops/SK_select/result_2/mini_2_sl_l3/ablation/convlstm/fea_vis",
