...
#                    weight_decay=0.0001),
    ...
    meta=dict(
        ...
        ignore_index=255,
        save_path=r"/data1/ll20/Pub_dataset/EuroCrops/DE_2021/result_2/mini_2_sl_l3/DBL",
        area="DE",
        num_classlevel=[7, 40, 101, 133],
        best_iter=10,
        max_iter=10,
        train_level=3,
        train_mode="ce_no_no", #[lt_dw_no,ltpr_no,ltpr_dw_no,ce_no_no,ltpr_no_ce,ltpr_no_ag,ltpr_dw_ag,ltpr_no_cdce] 
        model_name="DBL",
        num_each_level=dict(
...
infer_config = dict(
    infer=dict(
        ...
        meta=dict(
            ...
            save_path="/data1/ll20/Pub_dataset/EuroCrops/DE_2021/result_2/mini_2_sl_l3/DBL/",
            num_classlevel=[101],
            label_level=3,
            map_dict={
