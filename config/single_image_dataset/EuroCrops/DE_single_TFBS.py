...
#        loss_lt=dict(type="LDAMLoss",
#                    params=dict(max_m=0.5, s=30,ignore_index=255)),
#        loss_lt=dict(type="PRSoftBalanceLoss",
#                    params=dict(ignore_index=255)),
...
#                     lstm_layers=2,
        ...
        meta=dict(
            ...
            save_path="/data1/ll20/Pub_dataset/EuroCrops/DE_2021/result_2/mini_2_sl_l3/tfbs/",
            num_classlevel=[101],
            label_level=3,
            map_dict={
          ...
          save_fea_path="/data1/ll20/Pub_dataset/EuroCrops/DE_2021/result_2/mini_2_sl_l3/ablation/tfbs/fea_vis",
