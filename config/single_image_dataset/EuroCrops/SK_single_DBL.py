...
#                    weight_decay=0.0001),
    ...
    meta=dict(
        ...
        ignore_index=255,
        save_path="/data1/ll20/Pub_dataset/EuroCrops/SK_select/result_2/mini_2_sl_l3/DBL_fg",
        area="SK",
        best_iter=10,
        max_iter=10,
        train_level=3,
...
infer_config = dict(
    infer=dict(
        ...
        meta=dict(
            ...
            save_path="/data1/ll20/Pub_dataset/EuroCrops/SK_select/result_2/mini_2_sl_l3/DBL/",
            num_classlevel=[73],
            label_level=3,
            map_dict={
                1: {
